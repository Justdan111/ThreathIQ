...
const THREATS = [
  {
    id: '#INC-89422',
    title: 'Traffic Accident at Downtown Intersection',
    description: 'Multi-vehicle collision reported at Main St and 5th Ave. Emergency services on scene. Avoid area.',
  ...
  {
    id: '#INC-89419',
    title: 'Suspicious Activity in Park Area',
    description: 'Multiple reports of suspicious individuals in Central Park near playground. Police dispatched.',
  ...
  },
  {
    ...
    description: 'Oak Street between 3rd and 4th Ave closed for utility work. Use alternate routes.',
    location: 'Oak Street',
    severity: 'MEDIUM',
    type: 'CLOSURE',
    verified: true,
  ...
  },
  {
    ...
    description: 'Distributed denial of service attack detected from 100+ nodes across multiple ISPs.',
  ...
  },
  {
    ...
    description: 'New botnet command and control infrastructure identified in East Africa region.',
